...
<body>
	...
	<div class="contentsection templete clear">
		<div class="maincontent clear">
			<form  method="post">
			  <div class="fuc">
				<a href="search.php">Modify Your Search</a>
			  </div>
    ...
    ?>
	 ...
	 <?php
        ...
        while($row = mysqli_fetch_array($result)){
				...
				<div class="searchrd">
				<a href='searchp.php?id=<?php echo htmlspecialchars($_SESSION["username"]); ?>&child=<?php echo $row['name'];?>'>Request for Adoption</a>
				</div>
			</div>
						<?php $i++;?>
				<?php 
...
.searchrd  a:hover, #active{background:#FEF4E5;color:#333;}
