...
<div class = "tabcontent" style = " float : left; width : 65%;">
	<form name = "donationform" method = "POST" action = "<?php echo htmlspecialchars("donationformprocess.php"); ?>" >
		...
		<section align = "margin-left : 400px" >
			<input type = "submit" name = "donation" value = "Submit" onclick = "validate()"/>
		</section>
	</form>
</div>
